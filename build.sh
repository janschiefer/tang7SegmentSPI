...
nextpnr-gowin --enable-globals --enable-auto-longwires --parallel-refine --threads 16 --json build.yosys.json --write build.nextpnr.json --device GW1NR-LV9QN88PC6/I5 --family GW1N-9C --cst tangnano9k.cst --freq 27 --timing-allow-fail -l nextpnr.log
